...
<div class="row g-3">
    <div class="col-3">
        ...
        <input type="text" class="form-control" placeholder="Shipping Cost" aria-label="Shipping Cost" id="inputCost">
    </div>
    <div class="col-3">
        <label for="inputFree" class="form-label">Free Shipping</label>
        <input type="text" class="form-control" placeholder="Free Shipping" aria-label="Free Shipping" id="inputFree">
    </div>
</div>
